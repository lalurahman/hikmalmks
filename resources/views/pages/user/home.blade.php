...
<!-- Mirrored from demo.egenslab.com/html/spinner/preview/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 14:33:15 GMT -->
...
<head>
    ...
    >
    <title>Beranda - Hikmal Makassar</title>
    <link
        rel="icon"
...
<body>
                    ...
                    <div class="content">
                        ...
                        <ul class="address-list">
                            ...
                            <li><span>Email:</span> <a
                                    href="https://demo.egenslab.com/cdn-cgi/l/email-protection#2d44434b426d48554c405d4148034e4240"
                                ><span
                                        class="__cf_email__"
    ...
    <div class="banner-section2">
        <img
            ...
            class="banner2-spring1"
            alt="image"
        >
        <img
            src="assets/images/icons/banner2-spring.svg"
            class="banner2-spring2"
            alt="image"
        >
        <img
            src="assets/images/icons/banner2-circle.svg"
            class="banner2-circle1"
            alt="image"
        >
        <img
            src="assets/images/icons/banner2-circle.svg"
            class="banner2-circle2"
            alt="image"
        >
        <img
            src="assets/images/bg/banner2-vector.png"
            class="banner2-vector"
            alt="image"
        >
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                <div class="col-xl-7 col-lg-10">
                                    <div class="banner2-content">
                                        ...
                                        <h2>Silahkan bergabung bersama kami</h2>
                                        <p>
                                            Mari saling silaturrahmi bersama Pemuda / Mahasiswa(i) yang berada di
                                            Makassar.
                                        </p>
                                        <a
                                            href="#"
    ...
    <div class="about-section2 pt-120">
        <img
            ...
            alt="image"
            class="about2-vector img-fluid"
        >
        <div class="container">
            <div class="row gy-5 justify-content-center">
                <div class="col-xl-6 pe-xl-4 pe-0 text-xl-start text-center">
                    <img
                ...
                <div class="col-xl-6 d-flex justify-content-xl-start justify-content-center">
                    <div
                        class="about3-content style-4 wow fadeInRight"
                        data-wow-duration="1.5s"
                        data-wow-delay=".2s"
                    >
                        <span>-About Our Company-</span>
                        <h3>Digital marketing with omnichannel possibilities</h3>
                        <h4>We’re committed to delivering the best digital marketing for your businesses</h4>
                        <p class="para">Lorem Ipsum is simply dummy text of free available in market the way printing
                            and typesetting industry has been the industry's standard dummy text ever.</p>
                        <ul class="about3-list style-2">
                        ...
                        <div class="about-footer d-flex jusify-content-start align-items-center flex-wrap gap-4">
                            <a
                                href="about.html"
                                class="eg-btn btn--primary2 capsule btn--lg"
                            >MORE ABOUT</a>
    ...
    <div class="portfolio-section pb-120">
        <div class="container">
            ...
            <div class="row position-relative justify-content-center">
                <div class="swiper portfolio-slider2 swiper-fix">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div
                                class="portfolio-item1 style-2 wow fadeInDown"
                                data-wow-duration="1.5s"
                                data-wow-delay="0.2s"
                            >
                ...
                <div class="slider-bottom d-flex justify-content-between align-items-center">
                    <div class="swiper-pagination style-2 d-lg-block d-none"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="blog-section bg-white pb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
    ...
    <div class="join-section">
        <div class="container">
            <div class="joinus-area d-flex align-items-center">
                <div class="row d-flex align-items-center g-4">
                    ...
                    <div class="col-lg-5 d-flex justify-content-lg-end justify-content-center">
                        <a
                            href="contact.html"
                            class="eg-btn btn--primary2 joinus-btn"
                        >Join Us</a>
                    </div>
                </div>
            </div>
    ...
    <footer class="style-2 ">
        ...
        >
        <img
            src="assets/images/bg/footer-vectr2.png"
                ...
                <div class="row gy-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <a href="index.html"><img
                                    alt="image"
                                    src="assets/images/icons/footer2-logo.svg"
                                ></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                        <div class="footer-item">
                            ...
                            <ul class="footer-list">
                                <li><a href="service.html">Strategy & Research</a></li>
                                <li><a href="service.html">Web Development</a></li>
                                <li><a href="service.html">Web Solution</a></li>
                                <li><a href="service.html">Digital Merketing</a></li>
                                <li><a href="service.html">App Design</a></li>
                        ...
                        <div class="footer-item">
                            ...
                            <ul class="address-list">
                                ...
                                <li>
                                    ...
                                    <a
                                        href="https://demo.egenslab.com/cdn-cgi/l/email-protection#442d2a222b04213c25293428216a272b29"><span
                                            class="__cf_email__"
...
<!-- Mirrored from demo.egenslab.com/html/spinner/preview/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 14:33:51 GMT -->
