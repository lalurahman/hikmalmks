...
<head>
    ...
    <meta charset="utf-8" />
    <title>
        @yield('title', 'Bursa GTK - Provinsi Sulawesi Selatan')
    </title>
    <meta
        name="description"
...
>
    ...
    >
        ...
        <a href="#">
            <img
                alt="Logo"
                src="{{ asset('assets_admin/images/logo.webp') }}"
                width="50"
            />
        </a>
        <!--end::Logo-->
        ...
        <div class="d-flex align-items-center">
            ...
            >
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:assets_admin/media/svg/icons/General/User.svg-->
                    <svg
                ...
                >
                    ...
                    >
                        <span class="svg-icon svg-icon svg-icon-xl">
                            <!--begin::Svg Icon | path:assets_admin/media/svg/icons/Navigation/Angle-double-left.svg-->
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px"
                            ...
                            <div class="topbar-item">
                                <div class="w-auto d-flex align-items-center px-2">
                                    ...
                                    >
                                        ...
                                        <button
                                            type="submit"
                                            class="btn btn-icon btn-clean btn-danger btn-sm btn-logout"
                                        >
    ...
    >
        <span class="svg-icon">
            <!--begin::Svg Icon | path:assets_admin/media/svg/icons/Navigation/Up-2.svg-->
            <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                width="24px"
    ...
    <script>
        ...
        function dateTime() {
            ...
            span.textContent =
                days[day] + ", " + date + " " + months[month] + " " + year + " | " + ("0" + h).substr(-2) + ":" + ("0" +
                    m)
                .substr(-2) + ":" + ("0" + s).substr(-2);
        }
