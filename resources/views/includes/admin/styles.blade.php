...
<link
    href="{{ asset('assets_admin/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}"
    rel="stylesheet"
    type="text/css"
/>
...
/>
<link
    href="{{ asset('assets_admin/css/themes/layout/brand/light.css') }}"
    rel="stylesheet"
    type="text/css"
/>
<link
    href="{{ asset('assets_admin/css/themes/layout/aside/light.css') }}"
    rel="stylesheet"
    type="text/css"
/>
<!--end::Layout Themes-->
